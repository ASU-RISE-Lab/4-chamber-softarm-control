...
FileName      = 'func1stWithPmDynAmpOffDiag';       % File describing the model structure.
...
for i = 1:length(testData.pm_psi)
    ...
    x_pred(i,:) = funcRK4fullODEOffDiagv1_m(x10x1,u6x1,h,par_set);
    x10x1 = x_pred(i,:)';
end
% Plot result
close all
...
hold on
plot(testData.pm_psi(:,1)+testData.pm_psi(:,2),'k')

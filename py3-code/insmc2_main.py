    ...
    def th_data_exchange(self):# thread config of read data from mocap and send packed msg to record file.
        ...
        while self.run_event.is_set() and self.th2_flag:
            try:
                ...
                self.eta1 = self.dit0[0]*np.exp(-l1*t) +self.dtddmax1/l1
                ...
                self.eta2 = self.dit0[1]*np.exp(-l2*t) +self.dtddmax2/l2
                ...
                self.eta3 = self.dit0[2]*np.exp(-l3*t) +self.dtddmax3/l3
                ...
                self.eta4 = self.dit0[3]*np.exp(-l4*t) +self.dtddmax4/l4

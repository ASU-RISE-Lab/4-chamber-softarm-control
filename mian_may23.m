...
% plot(result_mat(:,1))
% hold on
plot(output_struct.state_array(:,1))
subplot(4,1,2)
% plot(result_mat(:,3))
hold on
plot(output_struct.state_array(:,3))
subplot(4,1,3)
% plot(result_mat(:,5))
hold on
plot(output_struct.state_array(:,5))
subplot(4,1,4)
% plot(result_mat(:,7))
hold on
plot(output_struct.state_array(:,7))
%%
x0 = output_struct.state_array(490,:);
for ti = 1:10
    ti
    result_mat(ti,:) = x0;

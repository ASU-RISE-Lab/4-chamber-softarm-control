function [dq10x1,y] = func1stWithPmDynAmpOffDiag(t,q10x1,u6x1,k1,k2,k3,k4,k21,k34,d1,d2,d3,d4,d21,d34,koff1,koff2,a1,a2,a3,a4,varargin)
...
Kmat = [k1, 0, 0,0;
        sign(theta1)*k21,k2,0,0;
        0, 0, k3,0;
        0,0, sign(theta2)*k34,k4];
Dmat = [d1, 0, 0,0;
        sign(theta1)*d21,d2,0,0;
        0, 0, d3,0;
        0,0, sign(theta2)*d34,d4];

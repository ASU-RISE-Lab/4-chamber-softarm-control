...
for d_counter = 2:par.n
    Di_v = simplify(rigid_m(d_counter)*J_v{d_counter}.'*J_v{d_counter});
    Di_w = simplify(J_w{d_counter}.'*I{d_counter}*J_w{d_counter});
...
syms l11 dl11 ddl11 l11_t(t) l12 dl12 ddl12 l12_t(t) r0
syms l21 dl21 ddl21 l21_t(t) l22 dl22 ddl22 l22_t(t) 
theta1 = (l11 - l12)/r0;
theta2 = (l21 -l22)/r0;
lc1 = (l11 + l12)/2;
lc2 = (l21 + l22)/2;

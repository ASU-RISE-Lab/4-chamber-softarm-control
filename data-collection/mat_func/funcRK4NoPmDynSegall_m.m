...
kk1 = -1.767*u4x1(1)^2+17.55*u4x1(1)+8.471;
kk2 = 10.25*u4x1(2)^2 - 325.1*u4x1(2)+3299;
kk3 =-1.013*u4x1(3)^2+11.55*u4x1(3)+4.419;
kk4 = 15.34*u4x1(4)^2 - 474.1*u4x1(2)+4475;

d1= 0.9725*u4x1(1)^2- 11.2*u4x1(1)+38.471;
d2= -0.9725*u4x1(1)^2+ 30.23*u4x1(1)+435.471;
d3=  0.1125*u4x1(1)^2- 1.2*u4x1(1)+14.471;
d4= 4.34*u4x1(4)^2 - 155.2.1*u4x1(2)+2146;

function [xk_est,Pk] =funcEKF_robust(xk_old,uk,zk,Pk_old,Q,R,H,dT,lambda)
...
%%%%%%%%%
vect = 1./eig(Pk_pre + H'/R*H);
gama_p2 = lambda*max(vect);
Rk_e =[(R +H*Pk_pre*H'),  (Pk_pre*H')';
       (Pk_pre*H'), (-gama_p2*eye(8)+Pk_pre)];
Pk = (eye(8) - Pk_pre*[H, eye(8)]/Rk_e*[H', eye(8)]')*Pk_pre;
%%%%%%%%%

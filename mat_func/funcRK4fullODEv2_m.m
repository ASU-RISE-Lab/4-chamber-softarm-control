function [x_new] = funcRK4fullODEv2_m(x14x1,alpha,beta,u6x1,h,gprMdl1,gprMdl2,gprMdl3,gprMdl4,par_set)
...
[M4x4,C4x1,G4x1,c] = funcMCGcal([theta1,dtheta1,lc1,dlc1,theta2,dtheta2,lc2,dlc2]);
c1 =c
dq4x1 = [dtheta1;dlc1;dtheta2;dlc2];
ddq4x1 = M4x4\(u_pm_tf - ypred4x1-C4x1*x14x1(8:2:14)-G4x1)

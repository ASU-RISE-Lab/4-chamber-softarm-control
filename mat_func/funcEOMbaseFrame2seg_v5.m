function par =funcEOMbaseFrame2seg_v5(par)
fprintf( 'EOM... \n' )
% par=[];
%% Transformations
par.n= 8;%DOF
...
%%% 1       xi(1)   0           -pi/2   0   
%%% 2       0      xi(2)-l1t0/2   0   
%%% 3       0      xi(3)-l1t0/2+a1   pi/2   0
%%% 4       xi(4)   0           0      0
%%% 5       xi(5)   0           -pi/2   0   
%%% 6       0      xi(6)-l2t0/2   0     0
%%% 7       0      xi(7)-l2t0/2+a1   pi/2   0
%%% 8       xi(8)        0      0
...
rigid_d(2)= xi(2)-l1t0/2;
rigid_d(3)= xi(3)-l1t0/2+a1;
rigid_d(6)= xi(6)-l2t0/2;
rigid_d(7)= xi(7)-l1t0/2+a1;

function [x_new] = funcRK4NoPmDynSegallpmpara_m(x4x1,u4x1,h,par_set)
%% 
%%%
...
u_pm_tf(3,1) = u4x1(3);
u_pm_tf(4,1) = u4x1(4);
kk1 =31.66;kk3 =30.3006;d1= 18.3847;d3= 20.9183;
% kk1 = -1.767*u4x1(1)^2+17.55*u4x1(1)+38.471;
...
% d3=  0.1125*u4x1(3)^2- 1.2*u4x1(3)+14.471;

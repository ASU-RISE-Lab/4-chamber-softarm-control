function nlgr =funcBuildGreyBox2seg()
    ...
    nlgr = setpar(nlgr, 'Unit', {'Nm/rad'; 'N/m'; 'Nm/rad'; 'N/m'; ...
                                 ...
                                 'None';'None';'None';'None'});
    nlgr = setpar(nlgr, 'Minimum',{eps(0)*1;eps(0)*1;eps(0)*1; ...
                                   eps(0)*1;eps(0)*1;eps(0)*1; ...
                                   eps(0)*1;eps(0)*1;eps(0)*1});   % All parameters > 0!

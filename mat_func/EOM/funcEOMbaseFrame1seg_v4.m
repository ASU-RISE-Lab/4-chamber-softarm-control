...
m_q=[0.5*theta1 b_theta1 b_theta1 0.5*theta1].';% 4x1
J_f=[diff(m_q,theta1),diff(m_q,lc1)];%6x2

temp.dJ_f=diff(subs(J_f,[theta1,lc1],[theta1_t(t),lc1_t(t)]),t);%6x2
dJ_fdt=subs(temp.dJ_f,[theta1_t(t),diff(theta1_t(t),t),lc1_t(t),diff(lc1_t(t),t)]...
    ,[theta1,dtheta1,lc1,dlc1]);% 6x2
par.J_xi2q=J_f;%6x2
temp.xi=m_q;%6x1
temp.dxi=J_f*[dtheta1 dlc1].'; %6x2 * 2x1
temp.ddxi=dJ_fdt*[dtheta1 dlc1].'+J_f*[ddtheta1 ddlc1].';% 6x2 * 2x1 + 6x2 * 1x1
% %%

...
Dmax4 = 1/d4*(dkmax4*abs(xold(2))+dcmax4*dxmax4);
    ...
    u3 = (d3)*(dtdxd(3,i)-kk3*xold(1)+eta03*e03+eta3*sign(e03));
    u4 = (d4)*(dtdxd(4,i)-kk4*xold(2)+eta04*e04+eta4*sign(e04));
    if u1 <=umin
        u1=umin;
    elseif u1>=umax
        u1=umax;
...
l2x = 0.001;eta02 = 1e0;   etalx2 =1e0;
dtdestmax2 = 0.01;
destold2 =0;
destnew2=0;
intvar2new =0;dtdintvar2 = 0;
